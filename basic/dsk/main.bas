...
8020return
9000'nada'
9010preset(0,0):print#1,"en"en"en0"ex(0)"en1"ex(1)
9090return
...
14090return
20000en=0:gosub12500:ex(en-1)=4*8:ey(en-1)=20*8
20030gosub12500:ex(en-1)=26*8:ey(en-1)=20*8
20040pb=2
20050px=3*8:py=18*8
20090return
20100en=0:gosub12500:ex(en-1)=14*8:ey(en-1)=5*8
20130gosub12500:ex(en-1)=28*8:ey(en-1)=4*8
20140pb=2
20150px=3*8:py=18*8
20190return
